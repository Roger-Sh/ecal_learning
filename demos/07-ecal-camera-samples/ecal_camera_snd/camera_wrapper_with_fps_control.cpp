...
/**
 * @brief Construct a new Camera Wrapper With Fps Control:: Camera Wrapper With Fps Control object
 * 
 * @param publisher 
 * @param camera_name 
 * @param width 
...
/**
 * @brief Destroy the Camera Wrapper With Fps Control:: Camera Wrapper With Fps Control object
 * 
 */
CameraWrapperWithFpsControl::~CameraWrapperWithFpsControl() {}
