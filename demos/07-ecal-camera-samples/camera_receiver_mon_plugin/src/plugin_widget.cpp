...
/**
 * @brief Construct a new Plugin Widget:: Plugin Widget object
 * init ecal subscriber, bind with subscriber callback
 * @param topic_name
 * @param topic_type
 * @param parent
 */
                       ...
                       received_message_counter_(0)
{
    ...
    // Add eCAL Callbacks
    compressed_image_subscriber_.AddReceiveCallback(
        std::bind(
            &PluginWidget::photoReceivedMessageCallback,
            this, std::placeholders::_2, std::placeholders::_3));
}

/**
 * @brief Destroy the Plugin Widget:: Plugin Widget object
 *
 */
PluginWidget::~PluginWidget()
{
...
void PluginWidget::updatePublishTimeLabel()
{
    ...
    if ((diff > std::chrono::milliseconds(100)) || (diff < std::chrono::milliseconds(-100)))
    {
